...
module CalendarDateSelect::FormHelpers
  ...
  def calendar_date_select(object, method, options={})
    ...
    options.merge!(:onfocus => calendar_date_select_invoke_javascript('$(this)', javascript_options))
...
tag.render,
  ...
  private
    def calendar_date_select_invoke_javascript(target, options)
      "new CalendarDateSelect( #{target}, #{options_for_javascript(options)} );"
    end
    ...
    def calendar_date_select_output(input, image, options = {}, javascript_options = {})
      ...
      if javascript_options[:embedded]
        ...
        out << " "
        out << image_tag(image,
            :onclick => calendar_date_select_invoke_javascript('$(this).previous()', javascript_options),
